...
```html
<script src="https://cdn.jsdelivr.net/npm/prosecco-js@v0.1.5/dist/prosecco.js">
```

For production releases, use the minified version:

```html
<script src="https://cdn.jsdelivr.net/npm/prosecco-js@v0.1.5/dist/prosecco.min.js">
```
